...
int main()
{
	int opcao, icont, jcont, kcont, lista = 0, finalizar = 0, matricula, posvetor, naluno, validamatricula = 0, validacpf = 0, validadatadenascimento = 0, validasexo = 0, somacpf = 0, contaluno=0;
